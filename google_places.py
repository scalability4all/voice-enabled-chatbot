...
def nearby_places(api_key, location, query, latitude, longitude, sort_by="prominence"):
...
def change_location_query(address, key):
    ...
    try:
        ...
        return user(city=location, longitude=longitude, latitude=lattitude,place_id=x[0]['place_id'])
    except Exception as e:
        print(e)
        return user(city="Hyderabad", longitude=17.44, latitude=78.34, place_id="ChIJK_h_8QMKzjsRlrTemJvoAp0")
